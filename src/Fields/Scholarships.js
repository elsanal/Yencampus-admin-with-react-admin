  ...
  const transform = data => ({
   ...
   return(
    ...
    <SimpleForm className={classes.simpleForm} redirect="list" warnWhenUnsavedChanges>
         ...
         <AutocompleteArrayInput source="eligible_english"   choices={countries.en} className={classes.selectInput}  
        ...
        <div className={classes.space}> </div>
         ...
         <AutocompleteArrayInput source="eligible_french"   choices={countries.fr} className={classes.selectInput}  
